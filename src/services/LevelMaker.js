...
export default class LevelMaker {
	...
	static levelOne() {
		...
		const birdQueue = new BirdQueue([BirdType.Yellow,BirdType.Yellow,BirdType.Yellow,BirdType.Yellow]);
	...
	static levelThree() {
		const blocks = [
			...
			new GlassBlock(LevelMaker.START_X + Block.SPRITE_MEASUREMENTS[Size.Medium].width * 8, CANVAS_HEIGHT - Ground.GRASS.height - Block.SPRITE_MEASUREMENTS[Size.Medium].height, Size.Large, Block.ANGLE_LEFT_DIAGONAL),
		];
		...
		const birdQueue = new BirdQueue([BirdType.White,BirdType.White,BirdType.White,BirdType.White,BirdType.White,BirdType.White]);
